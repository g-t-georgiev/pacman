...
function drawGhostBodyState2(ctx, centerX, centerY, radius, color) {
    ctx.fillStyle = color;
    drawPathFromPoints(ctx, centerX, centerY, radius, [
        [211, 1], [211, 11], [191, 11], [191, 21], [181, 21], [181, 31],
        [171, 31], [171, 51], [161, 51], [161, 141], [171, 141],
        [171, 131], [181, 131], [181, 121], [191, 121], [191, 131],
        [201, 131], [201, 141], [221, 141], [221, 121], [241, 121],
        [241, 141], [261, 141], [261, 131], [271, 131], [271, 121],
        [281, 121], [281, 131], [291, 131], [291, 141], [301, 141],
        [301, 51], [291, 51], [291, 31], [281, 31], [281, 21],
        [271, 21], [271, 11], [251, 11], [251, 1], [211, 1]
    ].map(([x, y]) => [x - 160, y]));
}
